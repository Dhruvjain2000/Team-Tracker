package com.example.android.teamtracker.ImageUpload;
...
import com.example.android.teamtracker.MainActivity;
...
public class ImageUploadActivity extends AppCompatActivity implements View.OnClickListener, EasyPermissions.PermissionCallbacks {
        ...
        photoRef.putFile(fileUri)
                ...
                .addOnFailureListener(this, new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        // [START_EXCLUDE]
                        hideProgressDialog();
                        Toast.makeText(getBaseContext(), "Error: upload failed",
