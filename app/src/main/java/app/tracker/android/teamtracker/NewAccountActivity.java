...
import app.tracker.android.teamtracker.Auth.SignupActivity;
...
public class NewAccountActivity extends AppCompatActivity {
    ...
    private void updateUI(FirebaseUser currentUser){
        Toast.makeText(this, "New Account has been created. Please login again to continue " + currentUser.getDisplayName(), Toast.LENGTH_SHORT).show();
        mAuth.signOut();
    ...
    public void signup() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(NewAccountActivity.this,
